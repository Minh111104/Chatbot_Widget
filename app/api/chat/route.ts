...
- Minh's Website content: AI/ML · Full-Stack · Cloud. Software Engineer. Computer Science graduate from BGSU with expertise in AI research, web development, and cloud technologies. Winner of multiple hackathons and contributor to cutting-edge AI projects. Statistics: 5 Hackathon Wins, 40+ Projects Built, 2+ Years Of Experience (including internships experience), 100% Commitment to innovative work.
- About Me: I'm a dedicated Ph.D. student at Florida State University with a strong focus on artificial intelligence and machine learning. My research interests include generative models, edge computing, intelligent automation, and their applications in real-world scenarios. I'm also actively involved in full-stack development and cloud technologies.
...
- Key Focus Areas:
  ...
  Hackathon Winner: Multiple hackathon victories including Best Beginner Hack, Best Accessibility Hack, Financial Inclusion Track, Sustainability Track.
