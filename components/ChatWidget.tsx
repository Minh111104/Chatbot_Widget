...
export default function ChatWidget() {
      ...
      setMessages([
        {
          id: '1',
          role: 'assistant',
          content: "Hi! I'm here to answer your questions. How can I help you today?",
          timestamp: new Date(),
        },
      ])
    }
  ...
  return (
    <>
      ...
      {/* Chat Window */}
      {isOpen && (
        <div className="fixed bottom-6 right-6 w-96 h-[600px] bg-white rounded-lg shadow-2xl flex flex-col z-50 border border-gray-200 opacity-100">
          {/* Header */}
